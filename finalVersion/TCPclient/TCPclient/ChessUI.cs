...
namespace TCPClient
{
    public partial class ChessUI : Form{
        ...
        public ChessUI(NetworkStream stream, String color){//,String ur,String their){
            InitializeComponent();
            GenerateButtonArray();
            //p1.Text += ur;
            //p2.Text += their;
            ...
            for(int i = 0; i < 64; i++){
                ...
                if(piece.GetColor() == "Black"){
                    if(piece.GetName() == "Bishop"){
                        buttons[i].Image = Properties.Resources.bb;
                    }
                    else if(piece.GetName() == "King"){
                        buttons[i].Image = Properties.Resources.bk;
                    }
                    else if(piece.GetName() == "Knight"){
                        buttons[i].Image = Properties.Resources.bn;
                    }
                    else if(piece.GetName() == "Pawn"){
                        buttons[i].Image = Properties.Resources.bp;
                    }
                    else if(piece.GetName() == "Queen"){
                        buttons[i].Image = Properties.Resources.bq;
                    }
                    else if(piece.GetName() == "Rook"){
                        buttons[i].Image = Properties.Resources.br;
                    }
                }
                else if(piece.GetColor() == "White"){
                    if(piece.GetName() == "Bishop"){
                        buttons[i].Image = Properties.Resources.wb;
                    }
                    else if(piece.GetName() == "King"){
                        buttons[i].Image = Properties.Resources.wk;
                    }
                    else if(piece.GetName() == "Knight"){
                        buttons[i].Image = Properties.Resources.wn;
                    }
                    else if(piece.GetName() == "Pawn"){
                        buttons[i].Image = Properties.Resources.wp;
                    }
                    else if(piece.GetName() == "Queen"){
                        buttons[i].Image = Properties.Resources.wq;
                    }
                    else if(piece.GetName() == "Rook"){
                        buttons[i].Image = Properties.Resources.wr;
                    }
                }
                else {
        ...
        private async void WaitForResponse(){
            try{
                ...
                if (data.Substring(0,4) == "8888")
                {
                    InfoLabel.Text = "Opponent disconnected. You won!";
                    game.EndGame();
                    stream.Close();
                }
                if (data.Substring(0,4)=="9999")
                {
                    InfoLabel.Text = "Opponent timed out. You won!";
                    game.EndGame();
                    stream.Close();
                }
            ...
            {
                InfoLabel.Text = "Server disconnected...";
                game.EndGame();
                stream.Close();
            }
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                timer1.Enabled = false;
                InfoLabel.Text = "Your time ran out...";
